...
function About() {
  return (
    <div className={styles.about}>
      <h1 className={styles.aboutTitle}>Meet the team</h1>
      <div className={styles.teamContainer}>
        <div className={styles.teamMember}>
          ...
          <p className={styles.description}>
            ...
            property with the single purpose of offering a genuine experience of
            Corfiot hospitality to our guests. Enjoy yourselves!
          </p>
        </div>
